...
Dependabot 低风险依赖升级遵循 [ADR-0004](../adr/ADR-0004-dependabot-leader-review.md)：仅在机器分类确认变更范围时由 Leader 单独审批；任何产品、服务器、治理、安全或发布路径都不能借此降级。该策略不修改 native Ruleset 的 last-push、签名、CODEOWNER 或 required-check 约束。
