...
| --------------------------------------------------------- | ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| Bun                                                       | `1.3.9`                                                                  | `mise.toml`, `mise.lock`, `scripts/verify-toolchain.sh`, `web/bun.lock`                              |
| Node.js                                                   | `>= 22.19.0` (CI: exact `26.5.0`)                                        | `mise.toml`, `mise.lock`, shared `.github/actions/setup-toolchain`                                   |
| PostgreSQL                                                | `16.x` (baseline `16.14`)                                                | `mise.toml`, `mise.lock`, `pg_dump`/`pg_restore` backup verification and integration environment     |
